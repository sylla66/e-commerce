...
const products = [
  // === ÉLECTRONIQUE ===
  {
    ...
    images: [PICSUM('galaxy1'), PICSUM('galaxy2'), PICSUM('phone2')],
  ...
  },
  {
    ...
    categorySlug: 'electronique',
    images: [PICSUM('macbook1'), PICSUM('macbook2'), PICSUM('macbook3')],
  ...
  },
  {
    ...
    categorySlug: 'electronique',
    images: [PICSUM('airpods1'), PICSUM('airpods2')],
  ...
  },
  {
    ...
    categorySlug: 'electronique',
    images: [PICSUM('jbl1'), PICSUM('jbl2')],
  ...
  },
  {
    ...
    categorySlug: 'mode',
    images: [PICSUM('bag1'), PICSUM('bag2'), PICSUM('bag3')],
  ...
  },
  {
    ...
    categorySlug: 'mode',
    images: [PICSUM('nike1'), PICSUM('nike2')],
  ...
  },
  {
    ...
    categorySlug: 'mode',
    images: [PICSUM('glasses1'), PICSUM('glasses2')],
  ...
  },
  {
    ...
    categorySlug: 'maison',
    images: [PICSUM('lampe1'), PICSUM('lampe2')],
  ...
  },
  {
    ...
    categorySlug: 'sport',
    images: [PICSUM('yoga1'), PICSUM('yoga2')],
  ...
  },
  {
    ...
    categorySlug: 'sport',
    images: [PICSUM('vtt1'), PICSUM('vtt2')],
